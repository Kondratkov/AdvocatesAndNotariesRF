package kondratkov.advocatesandnotariesrf.data_theme;
...
public class theme_data extends SQLiteOpenHelper implements BaseColumns {
    ...
    private static final String DATABASE_NAME = "mythemedata.db";
    ...
    public void onCreate(SQLiteDatabase db) {
        Log.d("qwerty", "onCreate DATABASE_CREATE_SCRIPT_mess DATABASE_CREATE_SCRIPT_forum");
    ...
    */
    public int getContactsCount() {
        ...
        Cursor cursor = db.query(DATABASE_TABLE,
                ...
                null,//COLUMN_IDU +" = "+in.get_id_user(),
                null,
                null,
                null,
                COLUMN_DATE);
